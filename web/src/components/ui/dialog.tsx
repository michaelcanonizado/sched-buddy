    ...
    <DialogPortal data-slot='dialog-portal'>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'bg-background fixed top-[50%] left-[50%] z-9999 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border p-4 shadow-lg sm:max-w-lg',
          className,
        )}
        {...props}
      >
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(textSubClassNames, className)}
      {...props}
    />
  )
}
