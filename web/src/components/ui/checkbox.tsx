...
function CheckboxCompact({
  ...
  const transitionClasses = 'transition-shadow'
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        transitionClasses,
        disabledClasses,
        'peer border-input dark:bg-input/30 size-4 shrink-0 rounded-[4px] border shadow-xs outline-none',
        className,
      )}
      {...props}
    >
...
export { Checkbox, CheckboxCompact }
